<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="TermsnConditions.aspx.vb" Inherits="TermsnCnditions" %>
        ...
        <table align="center">
            <tr align="left">
                <td align="left" class="style1" ><strong>
                    <asp:Label ID="lblheat" runat="server" Text="Terms And Conditions" Font-Size= "X-Large"  
                                            ...
                                            <tbody>
                                                <tr>
                                                    <td class="Orangebg" align="left" height="50">
                                                        ...
                                                        <p>
                                                                8. The tickets booked through Lemon Bus are cancellable. The refunded
                                                        ...
                                                        <p>
                                                                10. Cancellation / Refunds:<br>• For ticket cancelled <strong>before&nbsp;2 hours prior to the&nbsp;start time of departure
