    ...
    <table align="center">
        <tr align="left">
            <td align="left" class="style1" ><strong>
                <asp:Label ID="lblheat" runat="server" Text="Search Tickets" Font-Size= "X-Large"  
            ...
            <td>
                <!-- Left Table Start-->
                            ...
                            <table cellspacing="0" cellpadding="2" border="0" style="vertical-align:top; margin:0 auto;padding-top:25px" align="center">
                                <tbody>
                                    <tr>
                                        <td colspan="2" height="25"><strong>Enter The PNR number:</strong> </td>
                                    </tr>
                                    <tr>
                                        <td >
                                            <asp:TextBox ID="txtpnr" runat="server" />
                                            <asp:RequiredFieldValidator ID="rfvname" runat="server" ErrorMessage="*"  
                                                ControlToValidate="txtpnr" Display="Dynamic" ForeColor="Red" 
                                                ValidationGroup="abc" />
                                        </td>
                                        <td>
                                            <asp:Button ID="btnshow" runat="server" Text ="Display" ValidationGroup="abc"/>
                                        </td>
                                    </tr>
                                    <tr>
                                        <td align="center" colspan="2" height="25">
                                            <asp:CompareValidator ID="CompareValidator1" runat="server" 
                                                ControlToValidate="txtpnr" Display="Dynamic" ErrorMessage="*Cannot be String" 
                                                ForeColor="Red" SetFocusOnError="True" Type="Integer" 
                                                ValidationGroup="abc" Operator="DataTypeCheck"></asp:CompareValidator>
                                        </td>
                                    </tr>
                                </tbody>
                </table>
                                    ...
                                    <div id="Div1">
                                        <div>
                                            <table cellspacing="2" cellpadding="2" border="0" style="border:2px solid gray;padding:15px; ">
                                                <tbody  align="left"  >
                                                    <tr >
                                                        <td height="25"><strong>PNR Number </strong></td>
                                                        <td class="style3">:
                                                                </td>
                                                        <td>
                                                            <asp:Literal ID="litpnr" runat="server" />
                                                        </td>
                                                        <td style="margin-left:15px;width:100px"><strong>Agnet Name</strong></td>
                                                        <td>:</td>
                                                        <td>
                                                    ...
                                                    <tr>
                                                        <td align="left" height="25"><strong>Seat Number </strong></td>
                                                        <td align="left" class="style3">:
                                                                    </td>
                                                        <td align="left" class="style2">
                                                    ...
                                                    <tr>
                                                        <td align="left" height="25"><strong>Status</strong></td>
                                                        <td>:</td>
                                                        <td class="redtext">
                                                    ...
                                                    <tr>
                                                        <td class="redtext" height="25"><strong>Total Price</strong> </td>
                                                        <td class="style3">:
                                                                    </td >
                                                        <td colspan="4" class="redText"><strong>RM
