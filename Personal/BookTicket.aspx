<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="BookTicket.aspx.vb" Inherits="Personal_BookTicket" %>
...
<asp:Content ID="Content3" ContentPlaceHolderID="ContentPlaceHolder2" Runat="Server">
    <table align="center">
        <tr>
            <td><strong>
                <asp:Label ID="lblheat" runat="server" Text="Book Tickets Now!" Font-Size= "X-Large"  
    ...
    <asp:UpdatePanel ID="up" runat="server">
        <ContentTemplate>
            <table>
                                    ...
                                    <td align="center" class="style1">
                                        <div class="smallbox" style="margin: 0px">
                                            <table style="margin-left: 20px; width: 278px; height: 95px;" cellspacing="0" cellpadding="0"
                                                ...
                                                <tbody>
                                                    <tr>
                                                        <td class="formtext" width="37%" height="27">From:
                                                        </td>
                                                        <td width="63%" align="left" height="27">
                                                            <asp:DropDownList CssClass="form" ID="ddlDepart" runat="server">
                                                                <asp:ListItem Text="Kuala Lumpur" Value="Kuala Lumpur"></asp:ListItem>
                                                            </asp:DropDownList>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="formtext" width="37%" height="27">To:
                                                        </td>
                                                        <td width="63%" align="left" height="27">
                                                    ...
                                                    <tr>
                                                        <td class="formtext" width="37%" height="27">Depart Date : </td>
                                                        <td width="63%" align="left" height="27">
                                                    ...
                                                    <tr>
                                                        <td class="formtext" width="37%" height="27%">Time
                                                        </td>
                                                        <td width="63%" align="left" height="27">
                                                            <asp:UpdatePanel ID="up3" runat="server">
                                                                <ContentTemplate>
                                                                    <asp:DropDownList ID="DepartureTime" runat="server" AutoPostBack="True" >
                                                                    </asp:DropDownList>
                                                                </ContentTemplate>
                                                            </asp:UpdatePanel>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td class="formtext" height="27%" width="37%">Seat Number
                                                        </td>
                                                        <td align="left" height="27" width="63%">
                                                            <asp:TextBox ID="txtSeatNum" runat="server" ReadOnly="true"></asp:TextBox>
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td class="formtext" height="27%" width="37%">Price </td>
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td>
                                                                    ...
                                                                    <asp:RequiredFieldValidator ID="rfvName" runat="server" ErrorMessage="Require Name" ControlToValidate="txtName" ForeColor="Red" >*</asp:RequiredFieldValidator>
                                                                    <%--<asp:RangeValidator ID="range" Text ="Invalid Name" Type="String"   ControlToValidate="txtname" runat="server" /> --%></td>
                                                            </tr>
                                                            <tr>
                                                                <td height="25">Phone Number
                                                                </td>
                                                                <td>:
                                                                </td>
                                                                <td>
                                                                    <asp:TextBox ID="txtPhone" runat="server" />
                                                                    <asp:RequiredFieldValidator ID="rfvph" ControlToValidate="txtPhone" ErrorMessage="Require Phone Number"
                                                                        runat="server" ForeColor="Red" >*</asp:RequiredFieldValidator>
                                                                </td>
                                                                <tr>
                                                                    <td align="left" height="25">Total Seat
                                                                    </td>
                                                                    <td align="left">:
                                                                    </td>
                                                                    <td align="left">
                                                                ...
                                                                <tr>
                                                                    <td align="left" height="25">Price Per Seat </td>
                                                                    <td align="left" width="5%">:
                                                                    </td>
                                                                    <td align="left" width="49%">
                                                                        <asp:Label ID="lblPricePerSeat" runat="server"></asp:Label>
                                                                    </td>
                                                                </tr>
                                                                <tr>
                                                                    <td height="25" align="left">Bus Number
                                                                    </td>
                                                                ...
                                                                <tr>
                                                                    <td class="redText " height="25">Total Price</td>
                                                                    <td width="5%">:
                                                                    </td>
                                                                    <td class="redText">RM
                ...
                <tr>
                    <td align="right">
                        <asp:ImageButton ID="btnNext" ImageUrl="~/Images/btn_go.gif" runat="server"/>
                        <asp:ImageButton ID="btnSave" ImageUrl="~/Images/btn_go.gif" runat="server"
                            Visible="False" />
                    </td>
                </tr>
                <tr>
