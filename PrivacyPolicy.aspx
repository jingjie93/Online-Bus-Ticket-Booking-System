<%@ Page Title="" Language="VB" MasterPageFile="~/MasterPage.master" AutoEventWireup="false" CodeFile="PrivacyPolicy.aspx.vb" Inherits="PrivacyPolicy" %>
            ...
            <table align="center">
                <tr align="left">
                    <td align="left" class="style1" ><strong>
                        <asp:Label ID="lblheat" runat="server" Text="Privacy Policy" Font-Size= "X-Large"  
                                                        ...
                                                        <tr>
                                                            <td class="Orangebg" align="left" height="50">
                                                                ...
                                                                <p>
                                                                        ...
                                                                        of the information of those using the Lemon Bus website. Information that can be linked
                                                                ...
                                                                <p>
                                                                        All personal information you provide to Lemon Bus is transmitted using SSL (Secure
                                                                        ...
                                                                        travel purchases on Lemon Bus, you are protected.
                                                                </p>
                                                                </p>
                                                            </td>
                                                        </tr>
